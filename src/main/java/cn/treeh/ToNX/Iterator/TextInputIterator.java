...
public class TextInputIterator extends DefaultInputIterator {
    public String getThisLine() {
        return thisLine;
    }
    public TextInputIterator(String file) throws IOException{
        this(file, "\t", -1);
    }
    public TextInputIterator(String file, String s, int cols) throws IOException{
        super(file, s, cols);
    }
    @Override
